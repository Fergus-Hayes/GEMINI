function [nsi,vs1i,Tsi,xgin,ns,vs1,Ts]=eq2dist(eqdir,simID,xg, usehdf)

validateattributes(eqdir, {'char'}, {'vector'})
validateattributes(simID, {'char'}, {'vector'})
validateattributes(xg, {'struct'}, {'scalar'})

if nargin < 4, usehdf=true; end
validateattributes(usehdf, {'numeric'}, {'scalar','logical'})
